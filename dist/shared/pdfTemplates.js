...
exports.leaveRequestForm = exports.feedbackForm = exports.registrationForm = exports.jobApplicationForm = exports.formTemplate = exports.certificateTemplate = exports.payslipTemplate = exports.orderConfirmationTemplate = exports.quotationTemplate = exports.simpleDocument = exports.reportTemplate = exports.banglaReceiptTemplate = exports.receiptTemplate = exports.invoiceTemplate = void 0;
const PDFBuilder_1 = __importDefault(require("../app/builder/PDFBuilder"));
// ============ INVOICE TEMPLATE ============
...
const banglaReceiptTemplate = (data) => {
    return new PDFBuilder_1.default()
        .setTheme('modern')
        .setFont('bangla')
...
exports.banglaReceiptTemplate = banglaReceiptTemplate;
// ============ REPORT TEMPLATE ============
...
const simpleDocument = (title, content, options) => {
    var _a;
    return new PDFBuilder_1.default()
        .setTheme((options === null || options === void 0 ? void 0 : options.theme) || 'minimal')
        .setTitle(title)
        .setHeader({
        title: title,
        showDate: (_a = options === null || options === void 0 ? void 0 : options.showDate) !== null && _a !== void 0 ? _a : true,
    })
...
const quotationTemplate = (data) => {
  ...
  `);
    ...
    builder.setFooter({
        showPageNumbers: true,
        text: `${data.companyName} | This quotation is valid until ${((_a = data.validUntil) === null || _a === void 0 ? void 0 : _a.toLocaleDateString()) || 'further notice'}`,
    });
    return builder;
};
